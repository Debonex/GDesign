  ...
  <index-layout class="flex items-center justify-center">
    <b-form @submit="onSubmit" class="w-5/6 sm:w-96 bg-gray-200 p-12 rounded-lg">
      ...
      <b-form-group class="mt-6" label="确认密码" label-for="input-password2">
        <b-form-input v-model="form.password2" required type="password" placeholder="请确认密码"> </b-form-input>
      </b-form-group>
      <b-button class="mt-6 w-full" type="submit" variant="success">注册</b-button>
    </b-form>
  </index-layout>
</template>
