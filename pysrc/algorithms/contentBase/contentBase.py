...
class ContentBase:
    ...
    def load_data(self):
        if not (os.path.exists('data/train.json') and os.path.exists('data/test.json')):
            self.save_data()
        self.train = json.load(open("data/train.json"))
        self.test = json.load(open("data/test.json"))
